            ...
            <div className="product-dtl">
              ...
              <div className="product-count col-lg-7 ">
                <div className="flex-box d-flex justify-content-between align-items-center">
                  <h3>Giá</h3>
                  <span>{product.price}VNĐ/sản phẩm</span>
                </div>
                <div className="flex-box d-flex justify-content-between align-items-center">
                  <h3>Trạng thái</h3>
            ...
            </div>
            {
              ...
              <div className="my-4">
                ...
                <select value={rating} onChange={(e) => setRating(e.target.value)} className="col-12 bg-light p-3 mt-2 border-0 rounded">
                  ...
                  <option value="4">4 - Quá tốt</option>
              ...
              <div className="my-3">
                <button disabled={loadingCreateReview} className="col-12 bg-dark border-0 p-3 rounded text-white">
                  ĐÁNH GIÁ
                </button>
              </div>
            </form>
