...
//create products
export const createProducts = (name, price, description,caterogy , image, countInStocks) => async (dispatch, getState) => {
    ...
    try{
        ...
        const {data} = await axios.post(`/api/products/`,{name, price, description,caterogy , image, countInStocks},config)
